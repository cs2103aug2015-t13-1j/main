...
public class StorageManager {
	 ...
	 */
	public static void openStorage() throws Exception {
		try {
			initializeStorage();
	 ...
	 * @throws Exception	if the task was unable to be written
	 */
	private static void setReader() throws Exception {
		try {
	...
	private static void setWriterWithAppend() throws Exception {
		try {
	...
	private static void setWriterWithoutAppend() throws Exception {
		try {
	...
	private static void closeReader() throws Exception {
		try {
	 ...
	 * @throws Exception	if the task was unable to be written
	 */
	private static Task[] initiateTaskList() throws Exception {
		try {
	 ...
	 * @throws Exception	if the task was unable to be written
	 */
	public static void writeTask(Task task) throws Exception {
		try {
